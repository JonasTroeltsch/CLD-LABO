...
```bash
$ aws ec2 create-subnet --vpc-id vpc-03d46c285a2af77ba --cidr-block "10.0.14.128/28" --availability-zone eu-west-3a --tag-specifications 'ResourceType=subnet,Tags=[{Key=Name,Value=SUB-PRIVATE-DEVOPSTEAM14b}]'
//create subnet A
{
    "Subnet": {
        "AvailabilityZone": "eu-west-3a",
        ...
        "MapPublicIpOnLaunch": false,
        "State": "available",
        "SubnetId": "subnet-08b11740a0852c58d",
        "VpcId": "vpc-03d46c285a2af77ba",
        "OwnerId": "709024702237",
        "AssignIpv6AddressOnCreation": false,
        "Ipv6CidrBlockAssociationSet": [],
        ...
        "SubnetArn": "arn:aws:ec2:eu-west-3:709024702237:subnet/subnet-08b11740a0852c58d",
        "EnableDns64": false,
        "Ipv6Native": false,
        "PrivateDnsNameOptionsOnLaunch": {
            "HostnameType": "ip-name",
