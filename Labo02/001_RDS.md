...
```bash
$ aws ec2 create-subnet --vpc-id vpc-03d46c285a2af77ba --cidr-block "10.0.14.128/28" --availability-zone eu-west-3a --tag-specifications 'ResourceType=subnet,Tags=[{Key=Name,Value=SUB-PRIVATE-DEVOPSTEAM14a}]'
//create subnet A
{
    "Subnet": {
        "AvailabilityZone": "eu-west-3a",
